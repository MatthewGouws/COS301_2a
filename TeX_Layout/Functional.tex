...
\newpage %Each point on a new page
  ...
  \begin{enumerate}
    \item Elaboration - This gives a template message about a topic to an individual user or a group.
    \item Importance - ***
    \item Dependency level - This depends on the user input; the system will parse through the words and build a summary accordingly
    \item Pre-conditions
    \begin{enumerate}
    	\item Condition 1 - Users have to be registered.
    	\item Condition 2 - Group must exist and have some members.
    \end{enumerate}
        \item Post-conditions
    \begin{enumerate}
  ...
  \end{enumerate}
    \begin{figure}[h]
    	\centering
    	\includegraphics[width=10cm, height=5cm]{"Diagrams/Use Case/MgsGeneration".jpg}
...
%Diagram to go here \includegraphics[width=350px]{UseCases/File_Name.png}
\newpage %Each point on a new page
   \item  Apply self-organasation based on social tagging and allow the user to view according to the base structure, owns structure or public structure % point 15 // Neo
  \begin{enumerate}
    \item Elaboration - The user is able to add social tags that tell us more about a post thus is also able to search for a thread according to topics that have those social tags. But the user is also able to view according to the base structure given by the buzz system or specify their own structure there is also a general structure for the public who are not registered users.  The system may also add tags by parsing user input for keywords.
    \item Importance - ***
    ...
    \end{enumerate}
        \item Post-conditions
    \begin{enumerate}
    	\item Condition - Base structure of posts that is sorted according to social tags.
    \end{enumerate}
    \item Requester : The user.
  \end{enumerate}
    \begin{figure}[h]
    	\centering
    	\includegraphics[width=10cm, height=5cm]{"Diagrams/Use Case/SocialTags".jpg}
