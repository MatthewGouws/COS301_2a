...
\begin{figure}[h]
	\centering
	\includegraphics[width=345px]{"Diagrams/Use Case/KT_AC_Point6".jpg}
	\caption{Semi-automatic creation of thread summaries Activity Diagram}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[width=345px]{"Diagrams/Use Case/KT_CD_Point6".jpg}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=345px]{"Diagrams/Use Case/KT_AC_Point14".jpg}
	\caption{Apply Social Tagging Activity Diagram}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[width=345px]{"Diagrams/Use Case/KT_CD_Point14".jpg}
...
>>>>>>> ba105825c71e2e5fa7df16e61961a8fdf4ecb922
  \begin{enumerate}
...
\end{figure}
\clearpage %Each point on a new page
   \item Detect violation of netiquette rules. % Point 1 - Syzmon
	\begin{enumerate}
