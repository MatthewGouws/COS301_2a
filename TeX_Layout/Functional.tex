...
26-02-2015 & version 0.5.2 & Added Diagrams - Ivan \\% Comitted by Matthew due to Ivan Load shedding
...
\clearpage %Each point on a new page
  ...
  \begin{figure}[h]
  	...
  	\begin{figure}[h]
  		\centering
  		\includegraphics[width=300px]{"Diagrams/UML/ReadStatisticsClassDiagram".png}
  		\caption{Highlighting/Read Statistics Class Diagram}
  	\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=345px]{"Diagrams/Use Case/StaffManageContentUseCase".png}
	\caption{Staff Management of Content - Use Case}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[width=400px]{"Diagrams/Process Specification/StaffManageContentActivityDiagram".png}
	\caption{Staff Management of Content - Process Specification}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[width=400px]{"Diagrams/UML/ManageThreadUML".png}
	\caption{Staff Management of Content - UML}
\end{figure}
...
\item Provide functions such as searching and filtering. % Point 10 - Rendani
  ...
  \begin{figure}
  \centering
	\includegraphics[width=300px]{"Diagrams/UML/SearchClassDiagram".png}
	\caption{Searching and Filtering Class Diagram}
  \end{figure}
\clearpage %Each point on a new page
...
\begin{figure}[h]
	\centering
	\includegraphics[width=345px]{"Diagrams/Use Case/PostEditorEnhancementsUseCase".png}
	\caption{Post Editor for enhanced posts - Use Case}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[width=400px]{"Diagrams/Process Specification/postEditorEnhancementsActivityDiagram".png}
	\caption{Post Editor for enhanced posts - Process Specification}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[width=400px]{"Diagrams/UML/postEditorEnhancementsUML".png}
	\caption{Post Editor for enhanced posts - UML}
\end{figure}
